...
#ifndef SWIG_libsikuli_WRAP_H_
#define SWIG_libsikuli_WRAP_H_
...
class SwigDirector_ImageReadHelper : public sikuli::ImageReadHelper, public Swig::Director {

public:
    SwigDirector_ImageReadHelper(PyObject *self);
    virtual ~SwigDirector_ImageReadHelper();
    virtual std::string resolveImageFilename(std::string image_filename);
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (method == NULL) {
          std::string msg = "Method in class ImageReadHelper doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
