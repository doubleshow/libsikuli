...
#include "MacTestSuite.h"

static MacTestSuite suite_MacTestSuite;

static CxxTest::List Tests_MacTestSuite = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_MacTestSuite( "MacTestSuite.h", 15, "MacTestSuite", suite_MacTestSuite, Tests_MacTestSuite );
